...
def process_vision_info_dam(
    ...
    for vision_info in vision_infos:
        if "image" in vision_info or "image_url" in vision_info:
            ...
            raise ValueError("image, image_url, focal_crop or video should be in content.")
    ...
    if return_video_kwargs:
        return image_inputs, video_inputs, focal_inputs, {'fps': video_sample_fps_list}
